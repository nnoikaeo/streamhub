...
// Form validation
// Note: uid is NOT validated here — it's auto-generated by useAdminResource (user_${Date.now()})
// when creating a new user, and populated from props.user.uid when editing.
