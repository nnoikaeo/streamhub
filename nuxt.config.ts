...
export default defineNuxtConfig({
  ...
  //
  // The SPA shell (index.html) is generated by scripts/generate-spa-index.mjs
  // after the Nitro build completes. This avoids running a prerender server
  // with the firebase-functions SDK, which hangs in GitHub Actions (Azure infra)
  // because 169.254.169.254 is served by Azure IMDS (wrong format for GCP SDK).
  nitro: {
    preset: 'firebase',
    firebase: {
      gen: 2,
