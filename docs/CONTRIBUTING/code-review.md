...
- [ ] Lint adds no new problems: `npx eslint .` (3 pre-existing, all `no-explicit-any`; compare the count, or lint only your changed files). A violation of any **other** rule is new — fix it
