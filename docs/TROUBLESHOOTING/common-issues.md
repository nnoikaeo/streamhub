...
**สาเหตุ:** ตอนลด role ระบบถอด uid ออกจาก `assignedModerators` ของทุกโฟลเดอร์ ([folderAssignment.ts](../../app/utils/folderAssignment.ts)) — เป็นพฤติกรรมตั้งใจ แต่ไม่มีที่เก็บประวัติ จึงคืนให้อัตโนมัติไม่ได้ และฟอร์มยังไม่เตือนก่อน (BUG-027)
