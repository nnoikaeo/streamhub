...
| 3.10.16 | ป้าย "เข้าถึงได้ / หมดอายุแล้ว" ในคอลัมน์รายชื่อ | 1. ให้สิทธิ์บริษัท/กลุ่ม หรืออยู่ใต้โฟลเดอร์ที่ให้สิทธิ์ 2. ดูคอลัมน์ผู้ใช้ | คนที่เข้าถึงได้อยู่แล้วขึ้นป้ายเขียวพร้อมแหล่งที่มา (`บริษัท OAYT` / `กลุ่ม …` / `📁 Finance · …`); คนที่มีสิทธิ์แต่หมดอายุ/ถูกระงับขึ้นป้ายเหลือง; ป้ายต้องสอดคล้องกับแถบ "ผลลัพธ์รวม: n คน" | Medium | 🔍 |
...
| Admin Permissions | 16 | High | 🔍 partial (15 ✅ — 3.10.11–3.10.15 verified on prod 2026-08-19; 3.10.16 ป้ายในคอลัมน์รายชื่อ รอ UI pass) |
